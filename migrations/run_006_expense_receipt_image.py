#!/usr/bin/env python3
"""Apply migration 006 (expenses.receipt_image_url)."""
...
def main():
    ...
    try:
        with connection.cursor() as cursor:
            if not column_exists(cursor, database, "expenses", "receipt_image_url"):
                cursor.execute(ADD_COLUMN)
                print("Added expenses.receipt_image_url")
            else:
                print("receipt_image_url already exists — skipped")
        connection.commit()
